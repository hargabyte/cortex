...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .top-bar { position: fixed; top: 0; left: 0; right: 0; height: 48px; background: linear-gradient(135deg, #1a1a2e 0%%, #16213e 100%%); display: flex; align-items: center; justify-content: space-between; padding: 0 24px; z-index: 1500; box-shadow: 0 2px 8px rgba(0,0,0,0.2); }
    .top-bar-brand { display: flex; align-items: center; gap: 12px; color: white; text-decoration: none; }
    .top-bar-brand:hover { opacity: 0.9; }
    .top-bar-logo { font-size: 1.5rem; }
    .top-bar-title { font-size: 1.1rem; font-weight: 600; letter-spacing: 0.5px; }
    .top-bar-subtitle { font-size: 0.75rem; opacity: 0.7; margin-left: 8px; }
    .top-bar-links { display: flex; gap: 16px; }
    .top-bar-link { color: white; text-decoration: none; font-size: 0.85rem; opacity: 0.8; display: flex; align-items: center; gap: 6px; }
    .top-bar-link:hover { opacity: 1; }
    .top-bar-link svg { width: 18px; height: 18px; fill: currentColor; }
    body { padding-top: 48px; }
  </style>
</head>
<body>
  <div class="top-bar">
    <a href="https://github.com/hargabyte/cortex" class="top-bar-brand" target="_blank">
      <span class="top-bar-logo">🧠</span>
      <span class="top-bar-title">Cortex</span>
      <span class="top-bar-subtitle">Interactive Playground</span>
    </a>
    <div class="top-bar-links">
      <a href="https://github.com/hargabyte/cortex" class="top-bar-link" target="_blank">
